    ...
    if moveleft(curr[0]):
        ...
        for i in Closed:
            if i[0]==moveleft(curr[0]):
                ...
                break
        if not flag:
            temp.append((moveleft(curr[0]),old,heur(moveleft(curr[0]))))
    if moveright(curr[0]):
        flag=0
        for i in Closed:
            if i[0]==moveright(curr[0]):
                ...
                break
        if not flag:
            temp.append((moveright(curr[0]),old,heur(moveright(curr[0]))))
    if movetop(curr[0]):
        flag=0
        for i in Closed:
            if i[0]==movetop(curr[0]):
                ...
                break
        if not flag:
            temp.append((movetop(curr[0]),old,heur(movetop(curr[0]))))
    if movebelow(curr[0]):
        flag=0
        for i in Closed:
            if i[0]==movebelow(curr[0]):
                ...
                break
        if not flag:
            temp.append((movebelow(curr[0]),old,heur(movebelow(curr[0]))))
